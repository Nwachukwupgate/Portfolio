...
const icons = { Ardour: Headphones, Shotcut: Film };
      ...
      <div className="mx-auto max-w-6xl">
        <div className="mb-16">
          ...
          <p className="mt-4 max-w-2xl text-muted">
            Beyond code, skilled in professional audio and video production
            tools that support content creation, training data workflows, and
